...
export function AboutSection() {
  return (
    <section id="about" className="py-24 md:py-36 px-6 md:px-12 lg:px-20 bg-[#111114] text-[#f4f1eb]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            >
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight leading-[0.92] mb-6">
                A STUDENT<br />
                <em className="font-serif italic font-normal text-[#00f0ff]">WHO BUILDS.</em>
              </h2>

              {/* Primary Brand Statement */}
              <div className="p-4 sm:p-5 rounded-2xl bg-[#181822] border-l-4 border-l-[#00f0ff] border-y border-r border-[#272736] mb-6">
                <Quote size={20} className="text-[#00f0ff] mb-2 opacity-60" />
                <p className="text-lg sm:text-xl font-mono font-medium text-white tracking-tight">
                  "{portfolioData.brandStatement}"
                </p>
                <p className="text-xs sm:text-sm font-sans text-[#a0a0b0] mt-2 font-light">
                  {portfolioData.secondaryBrandStatement}
                </p>
              </div>

              <p className="text-base sm:text-lg text-[#c4c4cc] font-light leading-relaxed mb-6">
              ...
              <div className="text-xs font-mono text-[#888894] flex flex-wrap gap-x-6 gap-y-2 pt-2 border-t border-[#22222c]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-20">
          <div className="bg-[#18181f] border border-[#262630] rounded-2xl p-6 flex flex-col justify-between">
            <div className="text-[10px] font-mono tracking-widest uppercase text-[#777782] mb-3 flex items-center gap-1.5">
            ...
            <div>
              ...
              <p className="text-xs text-[#888892] mt-1">High distinction</p>
            </div>
          </div>
          ...
          <div className="bg-[#18181f] border border-[#262630] rounded-2xl p-6 flex flex-col justify-between">
            ...
            <div>
              <span className="text-4xl sm:text-5xl font-bold font-mono tracking-tight text-white">
                02<span className="text-sm font-sans font-normal text-[#888892] ml-1">nd</span>
              </span>
              <p className="text-xs text-[#888892] mt-1">Academic Session (2025–2029)</p>
            </div>
          </div>
          ...
          <div className="bg-[#18181f] border border-[#262630] rounded-2xl p-6 flex flex-col justify-between">
            ...
            <div>
              <span className="text-2xl sm:text-3xl font-bold font-mono tracking-tight text-[#00f0ff]">
                AI / ML
              </span>
              <p className="text-xs text-[#888892] mt-1">CSE Applied Intelligence</p>
            </div>
          </div>
          ...
          <div className="bg-[#18181f] border border-[#262630] rounded-2xl p-6 flex flex-col justify-between">
            ...
            <div>
              ...
              <p className="text-xs text-[#888892] mt-1">{portfolioData.location}</p>
            </div>
          </div>
        </div>

        {/* Currently Building Showcase */}
        <div className="pt-12 border-t border-[#24242e]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8">
            ...
            <p className="text-xs font-mono text-[#777782]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {portfolioData.currentlyBuilding.map((item) => (
              <div
                key={item.name}
                className="bg-[#15151c] border border-[#262630] hover:border-[#383848] rounded-2xl p-6 flex flex-col justify-between transition-all duration-300"
              >
                <div>
                  ...
                  <p className="text-sm text-[#a5a5b0] leading-relaxed mb-4">
                    {item.description}
                  </p>
                </div>

                <div className="pt-4 border-t border-[#202028]">
                  <span className="text-[10px] font-mono text-[#777785] uppercase tracking-wider block mb-1">
                    FOCUS STACK
                  </span>
