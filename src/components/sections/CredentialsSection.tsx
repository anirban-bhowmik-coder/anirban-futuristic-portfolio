...
export function CredentialsSection() {
  ...
  return (
    <section
      id="credentials"
      className="py-12 sm:py-16 md:py-28 lg:py-32 px-4 sm:px-6 md:px-12 lg:px-20 bg-[#0f0f13] text-[#f4f1eb] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 mb-8 sm:mb-12 md:mb-16 items-start">
          <div className="lg:col-span-4">
            <span className="text-xs font-mono tracking-widest text-[#00f0ff] uppercase block mb-2 sm:mb-3 font-semibold">
              05 / CREDENTIALS &amp; RECOGNITION
            </span>
            <div className="h-[1px] w-16 bg-gradient-to-r from-[#00f0ff] to-transparent mb-3 sm:mb-4" />
          ...
          <div className="lg:col-span-8">
            <motion.h2
              ...
              className="text-3xl sm:text-5xl md:text-7xl font-semibold tracking-tight leading-[0.92] sm:leading-[0.9] mb-4 sm:mb-6"
            >
              PROOF OF<br />
            ...
            <p className="text-sm sm:text-lg text-[#b0b0be] font-light leading-relaxed max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6 items-stretch">
        ...
        <div className="mt-10 sm:mt-20 pt-8 sm:pt-16 border-t border-[#22222d]">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 sm:gap-4 mb-2">
            <div>
              <span className="text-xs font-mono tracking-widest text-amber-400 uppercase block mb-1 sm:mb-2 font-semibold">
        ...
        <div className="mt-10 sm:mt-16 p-4 sm:p-6 bg-[#14141c] border border-[#262636] rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-[#9999a8]">
