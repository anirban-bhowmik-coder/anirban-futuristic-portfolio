...
export function HeroSection({ onOpenResume }: HeroSectionProps) {
  ...
  return (
    <section id="home" className="hero relative min-h-[100svh] overflow-hidden flex items-center pt-28 pb-16 px-6 md:px-12 lg:px-20 bg-[#f4f1eb]">
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-[#111114]/5 border border-[#111114]/15 text-[#111114] text-[11px] font-mono tracking-widest uppercase mb-6 w-fit"
          >
          ...
          <motion.p
            ...
            className="text-xs md:text-sm font-mono tracking-widest text-[#55555e] uppercase mb-4"
          >
          ...
          <motion.h1
            ...
            className="text-6xl sm:text-7xl md:text-8xl xl:text-9xl font-semibold tracking-tight text-[#111114] leading-[0.88] mb-6"
          >
            ANIRBAN<br />
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-mono tracking-tight font-medium text-[#111114]">
              {portfolioData.headline}
            </h2>
            <p className="mt-2 text-base sm:text-lg text-[#55555e] font-serif italic max-w-xl">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-[#111114] text-[#111114] hover:bg-[#111114] hover:text-[#f4f1eb] font-mono text-xs transition-all"
            >
              <span>GITHUB</span>
              <Github size={15} />
            </a>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-[#111114]/10 hover:bg-[#111114]/20 text-[#111114] font-mono text-xs transition-all border border-[#111114]/20"
            >
              <span>RESUME</span>
              <FileText size={15} />
            </button>
          ...
          <motion.div
            ...
            className="mt-10 flex flex-wrap items-center gap-2 text-xs font-mono text-[#555562]"
          >
            ...
            {(["neural", "lattice", "pulse"] as const).map((mode) => (
              <button
                ...
                className={`px-3 py-1 rounded-full text-[10px] tracking-wider uppercase border transition-all ${
                  meshMode === mode
        ...
        <div className="lg:col-span-5 relative w-full h-[450px] md:h-[540px] lg:h-[620px] flex items-center justify-center">
          ...
          <div className="absolute -bottom-4 right-0 sm:right-4 w-64 md:w-72 pointer-events-auto z-20">
            <FloatingWindow title="ANIRBAN / KINETIC SYSTEM">
              <div className="text-[11px] font-mono leading-relaxed opacity-90">
                <div className="flex justify-between border-b border-[#333] pb-1 mb-2 text-[9px] text-[#00f0ff]">
                ...
                <div className="text-[10px] text-[#00f0ff] mt-2 pt-1 border-t border-[#26262e]">
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-6 left-6 md:left-20 flex items-center gap-2 text-[10px] font-mono tracking-widest text-[#777782] uppercase">
